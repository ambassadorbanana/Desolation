...
public class GameControllerB3 : MonoBehaviour
{
    ...
    IEnumerator SpawnWaves()
    {
        ...
        while (true)
        {
            ...
            if (gameOver)
            {
                restartText.text = "Ganbare! Restart Your Mission with G";
                restart = true;
    ...
    void UpdateScore()
    {
        ...
        if(score == 1000)
        {
            SceneManager.LoadScene("the_thouse");
        }
    }
    ...
    public void GameOver()
    {
        ...
        gameOverText.text = "You couldn't escape the drones...";
        gameOver = true;
